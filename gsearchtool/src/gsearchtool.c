...
setup_case_insensitive_arguments (GSearchWindow *gsearch)
{
  ...
  g_spawn_command_line_sync ("find /dev/null -iname 'string'", NULL,
                             &cmd_stderr, NULL, NULL);
                      ...
                      gboolean       first_pass)
{
  ...
  file_is_named_utf8 =
    g_strdup ((gchar *) gtk_entry_get_text (GTK_ENTRY (gsearch_history_entry_get_entry
  ...
  file_is_named_locale = g_locale_from_utf8 (file_is_named_utf8,
                                             -1, NULL, NULL, &error);
  ...
  if ((gtk_widget_get_visible (gsearch->available_options_vbox) == FALSE) ||
    ...
    if (gsearch->command_details->is_command_first_pass == TRUE) {
      ...
      if (show_thumbnails_enum == SPEED_TRADEOFF_ALWAYS ||
        ...
        if (gsearch->caja_schema_exists) {
          value = g_settings_get_value (gsearch->caja_settings,
                                        "thumbnail-limit");
          if (value) {
                            ...
                            GSearchWindow *gsearch)
{
  ...
  readable_date = get_readable_date (gsearch->search_results_date_format,
                                     time_val.tv_sec);
...
add_no_files_found_message (GSearchWindow * gsearch)
{
  ...
  gtk_tree_view_column_set_visible (gsearch->search_results_folder_column,
                                    FALSE);
  gtk_tree_view_column_set_visible (gsearch->search_results_size_column,
                                    FALSE);
  gtk_tree_view_column_set_visible (gsearch->search_results_type_column,
                                    FALSE);
  gtk_tree_view_column_set_visible (gsearch->search_results_date_column,
                                    FALSE);
...
gsearch_setup_goption_descriptions (void)
{
  ...
  GSearchGOptionEntries[i++].description =
    g_strdup (_("Sort files by one of the following: name, folder, size, type, or date"));
  GSearchGOptionEntries[i++].description =
...
handle_goption_args (GSearchWindow *gsearch)
{
  ...
  if (GSearchGOptionArguments.nouser) {
    goption_args_found = TRUE;
    add_constraint (gsearch, SEARCH_CONSTRAINT_OWNER_IS_UNRECOGNIZED,
                    NULL, TRUE);
  }
          ...
          if (fnmatch (gsearch->command_details->name_contains_pattern_string, filename, FNM_NOESCAPE | FNM_CASEFOLD ) != FNM_NOMATCH) {
            if (gsearch->command_details->is_command_show_hidden_files_enabled) {
              if (gsearch->command_details->is_command_regex_matching_enabled == FALSE) {
                add_file_to_search_results (string->str,
                                            gsearch->search_results_list_store,
                                            &gsearch->search_results_iter,
                                            gsearch);
              }
                      ...
                      gchar         *command)
{
  ...
  if (!g_spawn_async_with_pipes (g_get_home_dir (), argv, NULL,
                                 G_SPAWN_SEARCH_PATH,
                                 child_command_set_pgid_cb, NULL,
                                 &gsearch->command_details->command_pid,
...
create_additional_constraint_section (GSearchWindow *gsearch)
{
  ...
  gtk_box_pack_end (GTK_BOX (gsearch->available_options_vbox), hbox, FALSE,
                    FALSE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox), gsearch->available_options_label,
                      FALSE, FALSE, 0);
  ...
  gtk_label_set_mnemonic_widget (GTK_LABEL (gsearch->available_options_label),
  ...
  gtk_box_pack_start (GTK_BOX (hbox),
                      gsearch->available_options_combo_box, TRUE, TRUE, 0);
  ...
  g_signal_connect (G_OBJECT (gsearch->available_options_add_button),
                    "clicked",
  ...
  gtk_box_pack_end (GTK_BOX (hbox), gsearch->available_options_add_button,
                    FALSE, FALSE, 0);
}
...
create_search_results_section (GSearchWindow *gsearch)
{
  ...
  gtk_box_pack_start (GTK_BOX (hbox),
                      gsearch->progress_spinner, FALSE, FALSE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox),
                      gsearch->files_found_label, TRUE, TRUE, 0);
  ...
  gtk_tree_view_column_set_attributes (column,
                                       gsearch->search_results_name_cell_renderer,
                   ...
                   gboolean       escape_values)
{
  ...
  if (gtk_widget_get_visible (gsearch->available_options_vbox)) {
    for (list = gsearch->available_options_selected_list; list != NULL; list = g_list_next (list)) {
      ...
      case SEARCH_CONSTRAINT_CONTAINS_THE_TEXT:
        locale = g_locale_from_utf8 (constraint->data.text, -1, NULL, NULL,
                                     NULL);
        if (escape_values)
...
handle_gsettings_settings (GSearchWindow *gsearch)
{
  ...
  if (g_settings_get_boolean (gsearch->mate_search_tool_select_settings,
    ...
    add_constraint (gsearch, SEARCH_CONSTRAINT_SEARCH_OTHER_FILESYSTEMS,
                    NULL, FALSE);
  }
}
...
gsearch_app_create (GSearchWindow *gsearch)
{
  ...
  g_signal_connect (G_OBJECT (gsearch->window),
                              "size-allocate",
  ...
  gsearch->look_in_folder_button = gtk_file_chooser_button_new (_("Browse"),
  ...
  g_signal_connect (G_OBJECT (gsearch->look_in_folder_button),
  ...
  if (gsearch->is_window_accessible) {
    add_atk_namedesc (GTK_WIDGET (gsearch->look_in_folder_button),
                      _("Look in folder"),
                      _("Select the folder or device from which you want to begin the search."));
  }
  ...
  gtk_box_pack_start (GTK_BOX (container),
                      gsearch->show_more_options_expander, FALSE, FALSE, 0);
  g_signal_connect (G_OBJECT (gsearch->show_more_options_expander),
                    "notify::expanded",
  ...
  if (gsearch->is_window_accessible) {
    add_atk_namedesc (GTK_WIDGET (gsearch->show_more_options_expander),
  ...
  gtk_box_pack_start (GTK_BOX (vbox),
                      gsearch->search_results_vbox, TRUE, TRUE, 0);
  ...
  g_signal_connect (G_OBJECT (gsearch->find_button),
                    "clicked",
  ...
  g_signal_connect (G_OBJECT (gsearch->stop_button),
                    "clicked",
...
gsearchtool_setup_gsettings_notifications (GSearchWindow *gsearch)
{
  ...
  click_to_activate_pref = g_settings_get_string (gsearch->caja_settings,
                                                  "click-policy");
