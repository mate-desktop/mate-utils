...
is_path_hidden (const gchar *path)
{
  ...
  if (sub_str != NULL) {
    ...
    mate_desktop_str =
      g_strconcat (G_DIR_SEPARATOR_S, ".mate-desktop", G_DIR_SEPARATOR_S, NULL);
                                  ...
                                  gint       bottom_offset)
{
  ...
  result_pixbuf = gsearchtool_stretch_frame_image (frame_image,
                                                   left_offset,
                                                   top_offset,
                                                   right_offset,
                                                   bottom_offset,
...
gsearchtool_thumbnail_frame_image (GdkPixbuf **pixbuf)
{
  ...
  pixbuf_with_frame = gsearchtool_embed_image_in_frame (*pixbuf, frame,
                                                        3, 3, 6, 6);
                        ...
                        GtkIconTheme *icon_theme)
{
  ...
  icon_info = gtk_icon_theme_choose_icon (icon_theme,
                                          (const char **)icon_names, size, 0);
  if (icon_info == NULL) {
                            ...
                            GAppInfo    *app)
{
  ...
  if (app == NULL) {
    ...
    uri = g_filename_to_uri (file, NULL, NULL);
    result = g_app_info_launch_default_for_uri (uri,
    ...
    if (g_file == NULL) {
      ...
      result = g_app_info_launch (app, g_file_list,
